...
export const IRISH_COURT_IDENTIFIERS: IrishCourtIdentifier[] = [
  {
    code: "IESC",
    fullName: "Supreme Court of Ireland",
    level: "supreme",
    neutralCitationFrom: 2003,
  },
  {
    code: "IESCDET",
    fullName: "Supreme Court of Ireland (Determinations)",
    level: "supreme",
    neutralCitationFrom: 2014,
  },
  {
    code: "IECA",
    fullName: "Court of Appeal of Ireland",
    level: "court_of_appeal",
    neutralCitationFrom: 2014,
  },
  {
    code: "IEHC",
    fullName: "High Court of Ireland",
    level: "high_court",
    neutralCitationFrom: 2003,
  },
  {
    code: "IECC",
    fullName: "Circuit Court of Ireland",
    level: "circuit",
    neutralCitationFrom: null,
  },
  {
    code: "IEDC",
    fullName: "District Court of Ireland",
    level: "district",
    neutralCitationFrom: null,
  },
  {
    code: "IECMC",
    fullName: "Competition and Mergers Commission of Ireland",
    level: "specialist",
    neutralCitationFrom: null,
  },
  {
    code: "IESC",
    fullName: "Special Criminal Court of Ireland",
    level: "specialist",
    neutralCitationFrom: null,
  },
  {
    code: "IECLR",
    fullName: "Employment Law Reports",
    level: "specialist",
    neutralCitationFrom: null,
  },
  {
    code: "IELRC",
    fullName: "Law Reform Commission of Ireland",
    level: "specialist",
    neutralCitationFrom: null,
  },
  {
    code: "IECCA",
    fullName: "Court of Criminal Appeal of Ireland",
    level: "court_of_appeal",
    neutralCitationFrom: 2003,
  },
  {
    code: "IESC",
    fullName: "Supreme Court (historical)",
    level: "supreme",
    neutralCitationFrom: null,
  },
  {
    code: "IEHCBK",
    fullName: "High Court (Bankruptcy)",
    level: "high_court",
    neutralCitationFrom: null,
  },
  {
    code: "IELC",
    fullName: "Labour Court of Ireland",
    level: "specialist",
    neutralCitationFrom: null,
  },
  {
    code: "IEEAT",
    fullName: "Employment Appeals Tribunal",
    level: "specialist",
    neutralCitationFrom: null,
  },
  {
...
export const IRISH_REPORT_SERIES: IrishReportSeriesEntry[] = [
  ...
  {
    abbreviation: "IEHC",
    fullName: "Irish High Court Reports",
    type: "authorised",
    yearOrganised: true,
    source: "BAILII",
  },
  {
    abbreviation: "ILTR",
    fullName: "Irish Law Times Reports",
    type: "unauthorised_generalist",
    yearOrganised: false,
  ...
  {
    abbreviation: "DULJ",
    fullName: "Dublin University Law Journal",
  ...
  {
    abbreviation: "ICLR",
    fullName: "Irish Criminal Law Reports",
    type: "unauthorised_subject",
    yearOrganised: true,
  ...
  {
    abbreviation: "IELJ",
    fullName: "Irish Employment Law Journal",
    type: "unauthorised_subject",
    yearOrganised: true,
    source: "Public domain",
  },
  ...
  {
    abbreviation: "JIC",
    fullName: "Judgments of the Irish Courts",
    type: "unauthorised_generalist",
    yearOrganised: true,
    source: "Public domain",
  },
  {
    abbreviation: "IFLR",
    fullName: "Irish Family Law Reports",
    type: "unauthorised_subject",
    yearOrganised: true,
    source: "Public domain",
  },
  {
    abbreviation: "IPLR",
    fullName: "Irish Planning Law Reports",
    type: "unauthorised_subject",
    yearOrganised: true,
    source: "Public domain",
  },
