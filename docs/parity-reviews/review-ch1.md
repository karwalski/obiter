...
**Status:** FIXED (src/engine/data/latin-terms.ts — both rule lists encoded verbatim; 4 missing italicised terms added; 15 inverted terms + variants moved to exceptions; Macquarie-dependent extras kept provisional pending decisions.md entry, see wave-1 ch1 handoff). **Follow-up 2026-07-03 (RESEARCH-009):** free-source proxy pass (calibrated against the rule's 36 labelled terms) romanised 10 clear general-English borrowings; legal terms of art kept italic pending the Macquarie check. DECISION-016 stays OPEN.
