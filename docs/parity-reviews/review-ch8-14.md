...
**Status:** FIXED (src/engine/rules/v4/international/arbitral.ts — formatIcsidCase rewritten to the 11.2.2 shape: italic phase parenthetical, tribunal param defaulting to 'ICSID Arbitral Tribunal', pinpoint); HANDOFF (engine wiring — handoff/international.md §1 passes tribunal/pinpoint and adds the reported branch)
...
**Status:** FIXED (src/engine/rules/v4/international/supranational.ts — ser A pinpoint space-separated, chamber constraint documented, 'Application Nos' plural, test rewritten to ex 33); HANDOFF (engine wiring — handoff/international.md §2 routes reported data to formatEchrReportedCase)
...
**Status:** FIXED (src/engine/rules/v4/international/treaties.ts — new formatMou: en-dash parties, descriptor suppression with comma-pinpoint, formatPinpoint designators, treaty-series slot, URL; exact ex 15/16 tests); HANDOFF (engine wiring — handoff/international.md §3 rewires dispatchTreatyMou)
...
**Status:** FIXED (src/engine/rules/v4/international/un.ts — session added to formatUnCommunication and moved before the UN Doc number in formatUnCommitteeDecision; exact ex 38 test); HANDOFF (engine wiring — handoff/international.md §4 passes d.session through)
...
**Status:** FIXED (src/engine/rules/v4/international/un.ts — new formatUnSubmission; exact ex 41 test); HANDOFF (engine wiring — handoff/international.md §5 adds a dispatch path)
...
**Status:** FIXED (src/engine/rules/v4/international/icj.ts — new formatIcjUnreported covering 10.4.1 and the 10.4.2 pleading variant; exact ex 30/32/34 tests); HANDOFF (engine wiring — handoff/international.md §6)
...
**Status:** HANDOFF (engine wiring — handoff/international.md §1; formatStateArbitrationReported already produces the 11.2.1 shape — exact Olguín/ex 6 tests added, parties passed as caseName)
...
**Status:** FIXED (src/engine/rules/v4/international/icc-tribunals.ts — new formatIccCaseReported with trailing tribunal/chamber parenthetical; exact ex 23/24 tests); HANDOFF (engine wiring — handoff/international.md §8)
...
**Status:** FIXED (src/engine/rules/v4/international/economic.ts — optional documentDescription and pinpoint on formatWtoDocument; exact ex 5/6 tests); HANDOFF (engine wiring — handoff/international.md §9)
...
**Status:** FIXED (src/engine/rules/v4/international/supranational.ts — instrumentType deprecated/ignored, comma-preceded pinpoint added; test rewritten to exact ex 6 plus ex 11); HANDOFF (engine wiring — handoff/international.md §11)
...
**Status:** FIXED (src/engine/rules/v4/international/supranational.ts — new formatCjeuUnreportedCase with ECLI slot; trailing court parenthetical removed from formatCjeuCase; exact ex 23 test); HANDOFF (engine wiring — handoff/international.md §12)
...
**Status:** FIXED (src/engine/rules/v4/international/supranational.ts — comma-separated date, 'Doc No' label, optional session/pinpoint, optional title; exact ex 44/49 tests); HANDOFF (engine wiring — handoff/international.md §13)
...
**Status:** HANDOFF (datasets agent owns data/eu-case-prefixes.ts; no formatter fixed in this wave consumes it)
...
- **9.1 (PDF p.167):** `formatUnCharter` (`un.ts:30-32`) is correct and tested but has **no dispatcher type** (`engine.ts` maps no `un.charter`), so it is unreachable from the engine; it also hard-codes `art` so a Charter cite without a pinpoint or to a chapter is impossible. **Status:** FIXED in part (un.ts — article now optional so a pinpoint-less Charter cite is possible); HANDOFF (engine wiring — handoff/international.md §14 adds the missing 'un.charter' dispatch type).
...
- **10.2 dispatch:** `dispatchIcjDecision` defaults `reportSeries` to `"ICJ Reports"` (`engine.ts:1642`) — AGLC abbreviation is `ICJ Rep`; wrong output whenever the caller omits the series. One-line fix. (Counted as the low MISMATCH in the table.) **Status:** HANDOFF (engine wiring — handoff/international.md §7).
