...
Australian law students, legal academics, practitioners, and anyone who needs to cite legal sources according to AGLC4. Particularly useful for thesis writers, journal editors, court practitioners preparing submissions, and researchers working with international and foreign legal materials that existing tools cannot handle.
